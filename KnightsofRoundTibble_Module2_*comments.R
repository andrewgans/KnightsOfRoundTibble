...
#CPK: lots of unneeded stuff (examples, demonstration from project description, etc. ). Marked here and there. [-3]
...
#CPK: Reallt good work! Just remember to include only what you need for the prompts. 
